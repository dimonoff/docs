# Se connecter à Spatium

Pour des raisons de sécurité, l’accès à **Spatium** est limité aux personnes autorisées qui possèdent l’authentification appropriée.

Pour se connecter à Spatium, veuillez suivre ces étapes :

1.  Ouvrez un navigateur Web. Spatium est une application Web. Les navigateurs suivants ont été testés afin de connaitre leur compatibilité et sont supportés par Dimonoff (la plateforme Spatium n’est toujours pas optimisée pour utilisation sur téléphones intelligents et tablettes) :
